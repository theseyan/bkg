...
pub const struct_mtar_t = extern struct {
    read: ?*const fn ([*c]mtar_t, ?*anyopaque, c_uint) callconv(.C) c_int,
    write: ?*const fn ([*c]mtar_t, ?*const anyopaque, c_uint) callconv(.C) c_int,
    seek: ?*const fn ([*c]mtar_t, c_uint) callconv(.C) c_int,
    close: ?*const fn ([*c]mtar_t) callconv(.C) c_int,
    stream: ?*anyopaque,
    pos: c_uint,

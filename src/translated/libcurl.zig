...
pub const curl_progress_callback = ?fn (?*anyopaque, f64, f64, f64, f64) callconv(.C) c_int;
pub const curl_xferinfo_callback = ?fn (?*anyopaque, curl_off_t, curl_off_t, curl_off_t, curl_off_t) callconv(.C) c_int;
pub const curl_write_callback = ?fn ([*c]u8, usize, usize, ?*anyopaque) callconv(.C) usize;
pub const curl_resolver_start_callback = ?fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.C) c_int;
...
pub const struct_curl_fileinfo = extern struct {
    ...
    size: curl_off_t,
    hardlinks: c_long,
    strings: struct_unnamed_9,
    flags: c_uint,
    b_data: [*c]u8,
    b_size: usize,
    b_used: usize,
};
pub const curl_chunk_bgn_callback = ?fn (?*const anyopaque, ?*anyopaque, c_int) callconv(.C) c_long;
pub const curl_chunk_end_callback = ?fn (?*anyopaque) callconv(.C) c_long;
pub const curl_fnmatch_callback = ?fn (?*anyopaque, [*c]const u8, [*c]const u8) callconv(.C) c_int;
pub const curl_seek_callback = ?fn (?*anyopaque, curl_off_t, c_int) callconv(.C) c_int;
pub const curl_read_callback = ?fn ([*c]u8, usize, usize, ?*anyopaque) callconv(.C) usize;
pub const curl_trailer_callback = ?fn ([*c][*c]struct_curl_slist, ?*anyopaque) callconv(.C) c_int;
...
pub const curl_sockopt_callback = ?fn (?*anyopaque, curl_socket_t, curlsocktype) callconv(.C) c_int;
...
pub const curl_opensocket_callback = ?fn (?*anyopaque, curlsocktype, [*c]struct_curl_sockaddr) callconv(.C) curl_socket_t;
pub const curl_closesocket_callback = ?fn (?*anyopaque, curl_socket_t) callconv(.C) c_int;
...
pub const curl_ioctl_callback = ?fn (?*CURL, c_int, ?*anyopaque) callconv(.C) curlioerr;
pub const curl_malloc_callback = ?fn (usize) callconv(.C) ?*anyopaque;
pub const curl_free_callback = ?fn (?*anyopaque) callconv(.C) void;
pub const curl_realloc_callback = ?fn (?*anyopaque, usize) callconv(.C) ?*anyopaque;
pub const curl_strdup_callback = ?fn ([*c]const u8) callconv(.C) [*c]u8;
pub const curl_calloc_callback = ?fn (usize, usize) callconv(.C) ?*anyopaque;
...
pub const curl_debug_callback = ?fn (?*CURL, curl_infotype, [*c]u8, usize, ?*anyopaque) callconv(.C) c_int;
pub const curl_prereq_callback = ?fn (?*anyopaque, [*c]u8, [*c]u8, c_int, c_int) callconv(.C) c_int;
...
pub const curl_conv_callback = ?fn ([*c]u8, usize) callconv(.C) CURLcode;
pub const curl_ssl_ctx_callback = ?fn (?*CURL, ?*anyopaque, ?*anyopaque) callconv(.C) CURLcode;
...
pub const curl_sshkeycallback = ?fn (?*CURL, [*c]const struct_curl_khkey, [*c]const struct_curl_khkey, enum_curl_khmatch, ?*anyopaque) callconv(.C) c_int;
pub const curl_sshhostkeycallback = ?fn (?*anyopaque, c_int, [*c]const u8, usize) callconv(.C) c_int;
...
pub const curl_ftpmethod = c_uint; // libcurl/include/curl/curl.h:985:16: warning: struct demoted to opaque type - has bitfield
...
pub const curl_hstsread_callback = ?fn (?*CURL, ?*struct_curl_hstsentry, ?*anyopaque) callconv(.C) CURLSTScode;
pub const curl_hstswrite_callback = ?fn (?*CURL, ?*struct_curl_hstsentry, [*c]struct_curl_index, ?*anyopaque) callconv(.C) CURLSTScode;
...
pub const CURLOPT_LASTENTRY: c_int = 10318;
...
pub const curl_formget_callback = ?fn (?*anyopaque, [*c]const u8, usize) callconv(.C) usize;
...
pub const curl_lock_function = ?fn (?*CURL, curl_lock_data, curl_lock_access, ?*anyopaque) callconv(.C) void;
pub const curl_unlock_function = ?fn (?*CURL, curl_lock_data, ?*anyopaque) callconv(.C) void;
...
pub const curl_socket_callback = ?fn (?*CURL, curl_socket_t, c_int, ?*anyopaque, ?*anyopaque) callconv(.C) c_int;
pub const curl_multi_timer_callback = ?fn (?*CURLM, c_long, ?*anyopaque) callconv(.C) c_int;
...
pub const curl_push_callback = ?fn (?*CURL, ?*CURL, usize, ?*struct_curl_pushheaders, ?*anyopaque) callconv(.C) c_int;
...
pub const CURL_SUFFIX_CURL_OFF_T = @compileError("unable to translate macro: undefined identifier `L`"); // libcurl/include/curl/system.h:382:13
pub const CURL_SUFFIX_CURL_OFF_TU = @compileError("unable to translate macro: undefined identifier `UL`"); // libcurl/include/curl/system.h:383:13
...
pub const CURLINC_OFF_T_C_HLPR2 = @compileError("unable to translate C expr: unexpected token '##'"); // libcurl/include/curl/system.h:481:13
...
pub const CURLOPT = @compileError("unable to translate C expr: unexpected token '='"); // libcurl/include/curl/curl.h:1057:9
...
pub const LIBCURL_VERSION = "7.84.0";
pub const LIBCURL_VERSION_MAJOR = @as(c_int, 7);
pub const LIBCURL_VERSION_MINOR = @as(c_int, 84);
pub const LIBCURL_VERSION_PATCH = @as(c_int, 0);
pub const LIBCURL_VERSION_NUM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x075400, .hexadecimal);
pub const LIBCURL_TIMESTAMP = "2022-06-27";
...
pub const SIOCGSTAMP = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8906, .hexadecimal);
pub const SIOCGSTAMPNS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8907, .hexadecimal);
